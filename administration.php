...
echo '<h3>Bienvenue <span>' . $_SESSION["pseudo"] . '</span> !<br> Ici, vous pouvez ajouter des produits ou modifier ceux existants en suivant les instructions ci-dessous.</h3>';
?>
