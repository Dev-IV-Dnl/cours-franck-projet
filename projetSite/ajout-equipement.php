...
<?php
        if (isset($_POST['nom'])) {
            ...
            if ($nom == "" || $image == "" || $description == "" || $prix == "") {
                ...
                $ajout = "INSERT INTO equipement (nom, image, description, prix) VALUES (:nom, :image, :description, :prix)";
                ...
                header('Refresh:2');
                echo "Vous Venez d'ajouter un équipement avec succès !";
            }
        }
    }
}
